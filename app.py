...
titulo = "Los Niveles del Conocimiento"
pdf_url = 'https://www.riial.org/espacios/dpersona_doc4nr.pdf'
resumen = """
Alfonso López Quintás propone que los niveles de realidad reflejan las distintas formas en que las cosas existen, desde lo físico hasta lo espiritual, 
pasando por lo psicológico y lo interpersonal. En paralelo, los niveles de conducta se relacionan con cómo 
las personas interactúan con la realidad, oscilando entre lo funcional (uso de objetos) y lo relacional 
(encuentro con otros, apertura al sentido y trascendencia).
"""
...
st.image('https://acspm.cl/wp-content/uploads/2021/10/lopez-quintas.jpg')
st.title("Los niveles de realidad y de conducta")
instrucciones = """
